                    ...
                    <div data-repeater-item class="row mt-3">
                        <div class="col-sm-1">
                            <div class="form-group">
                                ...
                                <input id="available" name="resale[quantity_available]" type="text" class="form-control">
                            </div>
                        </div>
                       {{--  <div class="col-sm-2">
                            <div class="form-group">
                        ...
                        <div class="col-sm-1">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="resale[size]" style="text-transform: uppercase">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label for="">Material</label>
                                <input type="text" class="form-control" name="resale[material]">
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="form-group">
                                <label for="">Cor</label>
                                <select class="form-control select2" name="resale[color_id]">
                                    <option disabled>Selecione...</option>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="resale[additional_infor]" style="width: 100%; height: 10rem"></textarea>
                        </div>
                    </div>
                </div>
